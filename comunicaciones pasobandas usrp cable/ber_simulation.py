...
# Generated: Mon Mar  2 20:03:36 2020
##################################################
...
class ber_simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.menu.addTab(self.menu_widget_1, 'Senal en T4')
        ...
        self.menu_grid_layout_3.addWidget(self._qtgui_time_sink_x_1_win, 2, 0, 1, 1)
        for r in range(2, 3):
        ...
        self.interp_fir_filter_xxx_0_0_0_1 = filter.interp_fir_filter_ccc(Sps*32, (wform.rect(Sps*32,Sps*32)))
        self.interp_fir_filter_xxx_0_0_0_1.declare_sample_delay(0)
        ...
        self.connect((self.digital_chunks_to_symbols_xx, 0), (self.interp_fir_filter_xxx_0_0_0_1, 0))
        self.connect((self.digital_chunks_to_symbols_xx, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx, 0), (self.qtgui_time_sink_x_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0_0_0_1, 0), (self.b_upconverter_cf_0, 0))
    ...
    def set_Rs(self, Rs):
        ...
        self.b_upconverter_cf_0.set_Fc(self.Rs)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.b_upconverter_cf_0.set_samp_rate(self.samp_rate*32)
    ...
    def set_Sps(self, Sps):
        self.Sps = Sps
        self.set_h_rrc(wform.rrcos(self.Sps,self.ntaps,self.rolloff))
        self.interp_fir_filter_xxx_0_0_0_1.set_taps((wform.rect(self.Sps*32,self.Sps*32)))
